...
export const GUEST_MISSION_ROWS: MissionListItem[] = [
  ...
  },
  {
    ...
    description: "Buy at least 0.01 ETH of any meme token.",
    rewardPoints: 100,
    taskKind: "ONE_TIME",
    completed: false,
    progress: { current: 0, target: 0.01, unit: "ETH" },
  },
  {
    taskKey: "LAUNCHPAD_VOLUME_MONSTER",
    title: "Volume Monster",
    description: "Reach 1 ETH in cumulative trading volume.",
    rewardPoints: 300,
    taskKind: "MILESTONE",
    completed: false,
    progress: { current: 0, target: 1, unit: "ETH" },
  },
  {
