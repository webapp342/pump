-- Server-side gap-fill for pre-aggregated token_candles (pump.fun flat-bar style).
-- Run: sudo -u postgres psql -d pump_db -f db/migrations/026_gap_fill_candles.sql
